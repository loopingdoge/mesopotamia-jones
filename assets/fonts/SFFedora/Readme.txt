...
The following fonts are included:
 ...
 - SF Fedora Symbols
 - SF Fedora Titles
 - SF Fedora Titles, Italic
 - SF Fedora Titles Shadow
 - SF Fedora Titles Shadow, Italic

------------------------------------------------------------------------
SF Fedora - Version 1.0 - Features
------------------------------------------------------------------------
...
------------------------------------------------------------------------
SF Fedora - Version 1.0 - Special Characters
------------------------------------------------------------------------

 - SF Fedora Symbols

   - Mara Alphabet ---------------------------- press a-z
   - Mara Alphabet Shadow --------------------- press A-Z
   - Mara Numbers ----------------------------- press 0-9
   - Mara Numbers Shadow ---------------------- press shift + 0-9
   - Compass ---------------------------------- press ?
...
of use:
 ...
 - This FONT PACKAGE is FREEWARE for noncommercial use ONLY.  If you
   wish to use this FONT PACKAGE commercially (print publication,
   advertisements, etc...), please contact us at info@shyfonts.com
   for pricing.
